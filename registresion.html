		...
		<fieldset>
			...
			<table>
				...
				<tr height="40px">
                    ...
                    <td>
                        <input type="text" name="fName" id="fName" placeholder="please write your first name" autofocus>
                    </td>
                </tr>
                ...
                <tr height="40px">
                    ...
                    <td>
                        <input type="text" name="lName" id="lName" placeholder="write your last name">
                    </td>
                </tr>
                ...
                <tr height="40px">
                    ...
                    <td>
                        <input type="text" name="uName" id="uName" maxlength="10" placeholder="username_123">
                    </td>
                </tr>
